<?php
/**
 * CAVPP PBCore Quality Control Metadata Element Set plugin
 *
 * Creates a custom QC descriptive element set for 
...
/**
 * The CAVPP PBCore Quality Control Metadata Element Set plugin.
 * @package Omeka\Plugins\CAVPP_PBCoreElementSet
 */
class CAVPP_MD_QCElementSetPlugin extends Omeka_Plugin_AbstractPlugin
{
    private $_elementSetName = 'Quality Control Metadata';
